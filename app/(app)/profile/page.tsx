...
export default function ProfilePage() {
    ...
    return (
        <div className="profile-container" style={{ padding: '40px 24px', maxWidth: 800, margin: '0 auto' }}>
            <style>{`
        ...
        @media (max-width: 640px) {
          ...
          .profile-title { font-size: 36px; text-align: center; }
      ...
      `}</style>
            ...
            >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                    <div className="user-name-row" style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
                        <h2 style={{ fontSize: 'clamp(24px, 5vw, 32px)', fontWeight: 800, color: '#fff', fontFamily: 'Syne, sans-serif', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                            {username}
                        </h2>
                        <div style={{
                            display: 'flex', alignItems: 'center', gap: 6,
                            background: 'rgba(255, 184, 0, 0.1)', padding: '4px 10px',
                            borderRadius: 100, border: '1px solid rgba(255, 184, 0, 0.2)', width: 'fit-content'
                        }}>
                    ...
                    <p style={{ fontSize: 16, color: 'rgba(255,255,255,0.4)', marginTop: 4, wordBreak: 'break-all' }}>{user?.email}</p>
                </div>
            </motion.div>

            {/* Stats Grid */}
            <div className="stats-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 16, marginBottom: 40 }}>
                {statItems.map(({ icon: Icon, label, value, color }, i) => (
                    <motion.div
                        ...
                        className="stat-card"
                    >
                        <div style={{ width: 44, height: 44, borderRadius: 12, background: `${color}10`, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
            ...
            >
                <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                    ...
                    <div style={{ textAlign: 'left' }}>
                        ...
                        <p className="logout-text" style={{ fontSize: 13, color: 'rgba(251, 113, 133, 0.5)' }}>Securely end your current session</p>
                    </div>
                </div>
