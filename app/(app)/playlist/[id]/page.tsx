...
export default function PlaylistPage() {
  ...
  if (loading) return (
      <div style={{ padding: '40px 32px' }}>
        ...
        <div className="skeleton" style={{ height: 48, width: 300, borderRadius: 8, marginTop: 24, background: 'rgba(255,255,255,0.05)' }} />
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', display: 'flex', alignItems: 'flex-end', gap: 32 }}>
            ...
            <div style={{ flex: 1, paddingBottom: 8 }}>
              ...
              {editing ? (
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    <input
                        ...
                        autoFocus
                    />
                    <button onClick={saveEdit} style={{ background: '#34d39920', color: '#34d399', border: 'none', padding: 12, borderRadius: 12, cursor: 'pointer' }}><Check size={24} /></button>
                    <button onClick={() => setEditing(false)} style={{ background: 'rgba(255,255,255,0.05)', color: '#fff', border: 'none', padding: 12, borderRadius: 12, cursor: 'pointer' }}><X size={24} /></button>
                  </div>
              ) : (
                  <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                    ...
                    <button
                        ...
                        style={{ background: 'rgba(255,255,255,0.05)', border: 'none', color: 'rgba(255,255,255,0.4)', padding: 8, borderRadius: 8, cursor: 'pointer', marginTop: 10 }}
                    >
                      <Pencil size={18} />
                    </button>
                  </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 14, color: 'rgba(255,255,255,0.5)', marginTop: 16 }}>
